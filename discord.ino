...
/**
 * Sends a discord message to a discord webhook.
 * Certificate is required to send https POST request.
 * currently works on ESP32-WROOM-DA module.
*/
...
void loop() {
  ...
  if (client) {
...

    {
      ...
      if (https.begin(*client, "https://discord.com/api/webhook/tokenHere")) {  // HTTPS
        Serial.print("testing sending message");
        https.addHeader("Content-Type", "application/json");

        String jsondata = "{\"content\":\"arduino gang\",\"tts\":\"false\"}";
